...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
    ...
    m.def("fusedForwardTernaryLIF", &fusedForwardTernaryLIF, "forwardTernaryLIFKernel wrapper");
    m.def("fusedBackwardTernaryLIF", &fusedBackwardTernaryLIF, "backwardTernaryLIFKernel wrapper");
}
